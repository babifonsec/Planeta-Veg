    ...
    return Scaffold(
      body: Stack(
        children: [
          ...
          //CONSTROI WIDGETS DE ACORDO COM O FLUXO DE DADOS DO FIRESTORE
                  ...
                  child: Column(
                    ...
                    children: [
                                  ...
                                  StreamBuilder<QuerySnapshot>(
                                    ...
                                    builder: (context, snapshot) {
                                      ...
                                      if (!snapshot.hasData ||
                                        ...
                                        return const Center(
                                          child:
                                              Text('Nenhum Endereco encontrado.'),
                                        );
                                      }
                                      // Acessar o primeiro documento no QuerySnapshot
                                      final enderecoDoc = snapshot.data!.docs[0];
                      ...
                      Padding(
                        ...
                        child: Text(
                            'Horário de Atendimento: ${lojaData['horario']}'),
                      ),
                      Padding(
                        padding: const EdgeInsets.only(
                          left: 10,
